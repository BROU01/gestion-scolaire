...
var LANG_DATA = {
  fr: {
    ...
    'menu.discipline': 'Discipline & Assiduité',
    'menu.activites': 'Activités',
    'menu.ressources': 'Ressources',
    'menu.site': 'Site Public',
    'menu.enseignement': 'Enseignement',
    'menu.assiduite': 'Assiduité',
    'menu.monespace': 'Mon espace',
    'menu.viescolaire': 'Vie scolaire',
    'menu.mesenfants': 'Mes enfants',

    /* Admin section labels */
    'label.years': 'Années académiques',
    'label.filieres': 'Filières',
    'label.specialites': 'Spécialités',
    'label.classes': 'Classes',
    'label.students': 'Étudiants',
    'label.teachers': 'Enseignants',
    'label.subjects': 'Matières',
    'label.absences': 'Absences & Retards',
    'label.punishments': 'Punitions',
    'label.grades': 'Notes',
    'label.bonus-malus': 'Bonus / Malus',
    'label.my-classes': 'Mes classes',
    'label.my-students': 'Mes étudiants',
    'label.my-subjects': 'Mes matières',
    'label.my-subjects-student': 'Mes matières',
    'label.teacher-absences': 'Mes absences',
    'label.teacher-punish': 'Punitions données',
    'label.my-profile': 'Mon profil',
    'label.my-filiere': 'Ma filière',
    'label.my-class-student': 'Ma classe',
    'label.my-grades': 'Mes notes',
    'label.my-exams': 'Mes examens',
    'label.my-record': 'Mon casier',
    'label.my-attendance': 'Mes absences',
    'label.child-profile': 'Profil de mon enfant',
    'label.child-grades': 'Notes de mon enfant',
    'label.child-attendance': 'Absences & Retards',
    'label.child-record': 'Comportement',
    'label.activities': 'Activités',
    'label.calendar-view': 'Calendrier académique',
    'label.site-editor': 'Personnalisation du site',
    'label.scholarships': 'Bourses d\'études internationales',
    'label.dashboard': 'Tableau de bord',
    'label.appointments': 'Rendez-vous',
    'label.theme': 'Personnalisation',
    'label.candidates': 'Candidatures',
    'label.punitions': 'Punitions',
    'label.bonus': 'Bonus/Malus',
    'label.recentGrades': 'Dernières notes',
    'label.currentYear': 'Année en cours',
    'label.international': 'Bourses internationales — 25+ pays',
    ...
    'crud.edit': 'Modifier',
    'crud.noData': 'Aucune donnée.',
    'crud.noActiveYear': 'Aucune année active.',
    'crud.activeYear': 'Année académique en cours',
    'crud.active': 'Active',
    'crud.inactive': 'Passée',
  ...
  en: {
    ...
    'menu.principal': 'Main',
    'menu.administration': 'Administration',
    'menu.discipline': 'Discipline & Attendance',
    'menu.activites': 'Activities',
    'menu.ressources': 'Resources',
    'menu.site': 'Public Site',
    'menu.enseignement': 'Teaching',
    'menu.assiduite': 'Attendance',
    'menu.monespace': 'My Space',
    'menu.viescolaire': 'School Life',
    'menu.mesenfants': 'My Children',

    /* Admin section labels */
    'label.years': 'Academic Years',
    'label.filieres': 'Programs',
    'label.specialites': 'Specialties',
    'label.classes': 'Classes',
    'label.students': 'Students',
    'label.teachers': 'Teachers',
    'label.subjects': 'Subjects',
    'label.absences': 'Absences & Lates',
    'label.punishments': 'Punishments',
    'label.grades': 'Grades',
    'label.bonus-malus': 'Bonus / Malus',
    'label.my-classes': 'My Classes',
    'label.my-students': 'My Students',
    'label.my-subjects': 'My Subjects',
    'label.my-subjects-student': 'My Subjects',
    'label.teacher-absences': 'My Absences',
    'label.teacher-punish': 'Given Punishments',
    'label.my-profile': 'My Profile',
    'label.my-filiere': 'My Program',
    'label.my-class-student': 'My Class',
    'label.my-grades': 'My Grades',
    'label.my-exams': 'My Exams',
    'label.my-record': 'My Record',
    'label.my-attendance': 'My Absences',
    'label.child-profile': 'My Child\'s Profile',
    'label.child-grades': 'My Child\'s Grades',
    'label.child-attendance': 'Absences & Lates',
    'label.child-record': 'Behavior',
    'label.activities': 'Activities',
    'label.calendar-view': 'Academic Calendar',
    'label.site-editor': 'Site Customization',
    'label.scholarships': 'International Scholarships',
    'label.dashboard': 'Dashboard',
    'label.appointments': 'Appointments',
    'label.theme': 'Customization',
    'label.candidates': 'Candidates',
    'label.punitions': 'Punishments',
    'label.bonus': 'Bonus/Malus',
    'label.recentGrades': 'Recent Grades',
    'label.currentYear': 'Current Year',
    'label.international': 'International Scholarships — 25+ countries',
    ...
    'crud.edit': 'Edit',
    'crud.noData': 'No data.',
    'crud.noActiveYear': 'No active year.',
    'crud.activeYear': 'Current academic year',
    'crud.active': 'Active',
    'crud.inactive': 'Past',
